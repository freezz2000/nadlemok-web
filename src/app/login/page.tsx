    ...
    <div className="min-h-screen flex items-center justify-center bg-surface relative">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-text-muted mt-2">로그인하여 서비스를 이용하세요</p>
        </div>
        ...
        <div className="bg-white rounded-xl border border-border shadow-sm p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-border rounded-lg text-sm font-medium text-text hover:bg-surface transition-colors mb-6"
          >
